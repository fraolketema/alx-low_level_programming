 ...
 * @e_ident: pointer to an array containng the ELF magic numbers.
 ...
 * @e_ident: Pointer to an array containing the ELF clas
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
...
/**
 * print_data - A func that  Prints the data of an ELF header
